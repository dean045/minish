...
#    Updated: 2022/07/23 16:40:51 by vahemere         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cleaning.c init_exec_utils.c exec_utils.c execve.c init_exec.c ft_itoa.c here_doc.c ft_strcmp.c manage_export.c env.c pwd.c cd.c manage_built_in.c manage_built_in_utils.c export.c unset.c ft_strcpy.c export_parsing.c echo.c exit.c mem.c\
