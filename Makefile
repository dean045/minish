...
#    Updated: 2022/07/23 00:22:43 by vahemere         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cleaning.c  exec_utils.c execve.c init_exec.c ft_itoa.c here_doc.c ft_strcmp.c manage_export.c env.c pwd.c cd.c manage_built_in.c export.c unset.c ft_strcpy.c export_parsing.c echo.c exit.c mem.c\
